module "translation" {
  ...
  handler        = "lingolift.core_lambda_handlers.translation_handler"
...
module "literal_translation" {
  ...
  handler        = "lingolift.core_lambda_handlers.literal_translation_handler"
  openai_api_key = var.openai_api_key
}
...
module "response_suggestion" {
  ...
  handler        = "lingolift.core_lambda_handlers.response_suggestion_handler"
  openai_api_key = var.openai_api_key
}
